...
public class TestStep extends BaseEntity {
    ...
    public enum StepType {
        HTTP_REQUEST, ASSERTION, DELAY, SET_VARIABLE, CONDITIONAL, LOOP, SCRIPT, LOG, DATABASE_QUERY, GLOBAL_REF, PARALLEL, SOAP_REQUEST, DB_TABLE_VIEW, BROWSER_AUTOMATION, CSV_EXTRACT, MAINFRAME_TERMINAL, RESPONSE_PROCESSOR
    }
